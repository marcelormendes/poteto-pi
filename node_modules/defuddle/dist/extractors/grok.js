        ...
        return content.replace(linkPattern, (match, url, linkText) => {
            ...
            if (!footnote) {
                ...
                try {
                    ...
                    domainText = `<a href="${(0, dom_1.escapeHtml)(url)}" target="_blank" rel="noopener noreferrer">${(0, dom_1.escapeHtml)(domain)}</a>`;
                }
                catch (e) {
                    // Keep domainText as the original URL if parsing fails
                    domainText = `<a href="${(0, dom_1.escapeHtml)(url)}" target="_blank" rel="noopener noreferrer">${(0, dom_1.escapeHtml)(url)}</a>`;
