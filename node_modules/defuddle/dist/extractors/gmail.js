...
class GmailExtractor extends _base_1.BaseExtractor {
    canExtract() {
    ...
    extract() {
        ...
        const commentData = rows.map((m) => ({
            author: m.author,
            date: m.date,
            content: m.content,
            depth: 0,
        }));
        const commentsHtml = (0, comments_1.buildCommentTree)(commentData);
    ...
    getMessageBody(row) {
        ...
        return (0, dom_1.serializeHTML)(clone).trim();
    }
    static isBlank(node) {
    ...
    static trimTrailingBlanks(el) {
        ...
        if (last && (0, utils_1.isElement)(last))
            GmailExtractor.trimTrailingBlanks(last);
    }
    ...
    static stripPlainTextQuotes(root) {
...
exports.GmailExtractor = GmailExtractor;
...
GmailExtractor.REMOVE_SELECTORS = [
...
GmailExtractor.MEDIA_SELECTOR = 'img, picture, video, audio, iframe, svg, canvas, object, embed';
...
GmailExtractor.INLINE_TAGS = new Set([
    ...constants_1.INLINE_ELEMENTS,
