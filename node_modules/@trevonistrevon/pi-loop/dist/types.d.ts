...
export type WorkflowRevisionFailureCode = "loop_not_found" | "not_workflow" | "revision_conflict" | "run_conflict" | "terminal_workflow" | "workflow_paused" | "monitor_wait_active" | "revision_limit_reached" | "actor_required" | "execution_missing" | "execution_unowned" | "lease_expired" | "lease_owned_elsewhere" | "invalid_patch" | "current_state_immutable" | "state_conflict" | "edge_conflict" | "dependency_not_preserved" | "graph_invalid" | "definition_too_large";
