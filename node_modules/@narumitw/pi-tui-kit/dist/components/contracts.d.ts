...
declare const MENU_BINDINGS: readonly ["tui.select.up", "tui.select.down", "tui.select.pageUp", "tui.select.pageDown", "tui.select.confirm", "tui.select.cancel", "tui.input.submit"];
...
export type MenuChangeResponse<ScreenId extends string> = boolean | {
    accepted: boolean;
...
export interface MenuScreenComponentOptions<ScreenId extends string, ActionId extends string> {
    ...
    tui: RenderHost;
    theme: Pick<Theme, "fg" | "bold"> & Partial<Pick<Theme, "italic" | "underline" | "strikethrough">>;
...
export type BrowseOptions<ScreenId extends string, ActionId extends string> = MenuScreenComponentOptions<ScreenId, ActionId> & {
    screen: Extract<MenuScreen<ScreenId, ActionId>, {
        kind: "browse";
    }>;
};
export type MultiSelectOptions<ScreenId extends string, ActionId extends string> = MenuScreenComponentOptions<ScreenId, ActionId> & {
    screen: Extract<MenuScreen<ScreenId, ActionId>, {
        kind: "multiSelect";
    }>;
};
