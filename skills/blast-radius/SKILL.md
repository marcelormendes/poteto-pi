...
6. For a big or wide change, run it as an `arena`. Run several sequential passes over the same question, switching models between passes, and merge the answers. Different models catch different real bugs.
